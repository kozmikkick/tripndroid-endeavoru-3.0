...
static void baseband_xmm_power2_flashless_pm_ver_ge_1130_step3(struct work_struct *work)
{
...
static void baseband_xmm_power2_work_func(struct work_struct *work)
{
	...
	case BBXMM_WORK_INIT:
		...
		err = request_threaded_irq(
				...
				NULL, baseband_xmm_power2_ver_ge_1130_ipc_ap_wake_irq2,
				IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING,
				"xmm_power2_ipc_ap_wake_irq", NULL);
		if (err < 0) {
