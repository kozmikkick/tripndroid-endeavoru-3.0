...
static const unsigned int cpu_cold_offs_mhz[MAX_DVFS_FREQS] = {
	  50,  50,  50,  50,  50,  50,  50,  50,  50,   50,   50,   50,   50,   50,   50,   50,   25,   25,   25,   25};
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  4, 3, MHZ, 460, 460, 550, 550,  680,  680,  680,  820,  970,  970, 1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1360, 1500),
...
// GPU OC 484 START
	...
	CORE_DVFS("vde",    1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
// GPU OC 484 END
...
// GPU OC 484 START
	...
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  484000,  484000,  484000,  484000),
